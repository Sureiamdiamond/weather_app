          ...
          child: Column(
            ...
            children: [
              ...
              const Text("سید پارسا بنی طبا",
                style: AppTextStyles.subtitileInfo),
              const Divider(indent: 40,endIndent: 40),
              const Text(":شماره دانشجویی",  style: AppTextStyles.ttileInfoStyle),
              const Text("40022841054093" ,   style: AppTextStyles.subtitileInfo),
              const Divider(indent: 40,endIndent: 40),
              const Text(":نام استاد پروژه",  style: AppTextStyles.ttileInfoStyle),
              const Text("استاد حمیدرضا مقسمی",   style: AppTextStyles.subtitileInfo),
              const Divider(indent: 40,endIndent: 40),
              ...
              const Text(":شبکه های اجتماعی",   style: AppTextStyles.subtitileInfo),
