...
class SearchLocation extends UseCase<List<SearchLocationEntity>, SearchLocationParams> {
  final ForecastRepo forecastRepo;
  SearchLocation(this.forecastRepo);

  @override
  Future<Either<Failure, List<SearchLocationEntity>>> call(SearchLocationParams params)
  async {
